        ...
        <div class="container">
            <div class="top-info">
                <div class="contact-info d-none d-md-flex">
                    ...
                    <span><i class="fa-solid fa-envelope"></i> uisfruits@gmail.com</span>
                </div>
                <ul class="auth-links d-flex gap-2 mb-0 list-unstyled">
    ...
    <div class="main-header">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <!-- Offcanvas Sidebar -->
                <div class="offcanvas-sw d-md-none">
                ...
                <ul class="nav-menu col-md-5 d-none d-md-flex list-unstyled mb-0 gap-4">
                    ...
                    <li class="nav-item"><a href="shop.html">Sản phẩm</a></li>
                    <li class="nav-item"><a href="#">Tin tức</a></li>
                    <li class="nav-item"><a href="#">Liên hệ</a></li>
                </ul>

                <!-- Search Bar Section (mobile view) -->
                ...
                <div class="cart col-md-1">
                    ...
                    <a href="#">
                        ...
                        <span class="cart-count badge bg-danger translate-middle">0</span>
                    </a>
                </div>
            </div>
        </div>

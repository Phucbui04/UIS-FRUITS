                ...
                <div class="col-md-5">
                    <div class="product-images">
                        <div class="main-image">
                            <img id="main-image" src="{{ asset($product_detail->image) }}" alt="Product Main Image">
                        </div>
                ...
                <div class="col-md-7">
                    <div class="product-info">
                        ...
                        <ul class="product-status">
                            ...
                            <li class="status">Tình trạng: <span>
                        ...
                        <div class="product-price">
                            <div class="price">
                                $150.00 <span class="old-price">{{ $product_detail->price }} VND</span>
                            </div>
                        </div>

...
<div class="page-wrapper">
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="adduser.html" class="btn btn-added"><img src="{{asset('admins/assets/img/icons/plus.svg')}}" alt="img"
                    ...
                    <div class="search-set">
                        ...
                        <div class="search-input">
                            <a class="btn btn-searchset">
                                <img src="{{asset('admins/assets/img/icons/search-white.svg')}}" alt="img">
                            </a>
                        </div>
                    </div>
                    <div class="wordset">
                            ...
                            <div class="col-lg-1 col-sm-6 col-12 ms-auto">
                                <div class="form-group">
                                    <a class="btn btn-filters ms-auto"><img
                                            src="{{asset('admins/assets/img/icons/search-whites.svg')}}" alt="img"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table  datanew">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{asset('admins/assets/img/customer/customer1.jpg')}}" alt="product">
                                    </a>
                                </td>
                                <td>Thomas</td>
                                <td>Thomas </td>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{asset('admins/assets/img/customer/customer2.jpg')}}" alt="product">
                                    </a>
                                </td>
                                <td>Benjamin</td>
                                <td>Franklin </td>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{asset('admins/assets/img/customer/customer3.jpg')}}" alt="product">
                                    </a>
                                </td>
                                <td>James</td>
                                <td>James </td>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{asset('admins/assets/img/customer/customer4.jpg')}}" alt="product">
                                    </a>
                                </td>
                                <td>Bruklin</td>
                                <td>Bruklin </td>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{asset('admins/assets/img/customer/customer5.jpg')}}" alt="product">
                                    </a>
                                </td>
                                <td>Franklin</td>
                                <td>Jacob </td>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{asset('admins/assets/img/customer/customer6.jpg')}}" alt="product">
                                    </a>
                                </td>
                                <td>B. Huber </td>
                                <td>Jacob </td>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{asset('admins/assets/img/customer/customer7.jpg')}}" alt="product">
                                    </a>
                                </td>
                                <td>Alwin</td>
                                <td>Alwin </td>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{asset('admins/assets/img/customer/customer8.jpg')}}" alt="product">
                                    </a>
                                </td>
                                <td>Fred john</td>
                                <td>john </td>
